...
<html>
    ...
    <body>
        ...
        <div id="show-temperature" class="content scaffold-show" role="main">
            ...
            <f:display bean="temperature" />
            <g:form resource="${this.temperature}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.temperature}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
